...
urlpatterns = [
    ...
    path('api/projects/<int:project_id>/docs/<doc_id>/annotations/', AnnotationList.as_view(), name='annotations'),
    path('api/projects/<int:project_id>/docs/<doc_id>/annotations/<int:annotation_id>', AnnotationDetail.as_view(), name='ann'),
